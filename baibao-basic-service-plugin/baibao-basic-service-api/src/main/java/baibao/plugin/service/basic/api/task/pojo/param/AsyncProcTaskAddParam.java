...
@Data
@NoArgsConstructor
public class AsyncProcTaskAddParam implements Serializable {
     ...
     * 任务参数（JSON对象字符串）
     */
    @FieldMeta(description = "任务参数（JSON对象字符串）")
...
//    @NotNull(message = "开始时间不能为空")
     ...
     * 原始文件（JSON对象数组）
     */
    @FieldMeta(description = "原始文件（JSON对象数组）")
     ...
     * 错误信息（失败信息）
     */
    @FieldMeta(description = "错误信息（失败信息）")
