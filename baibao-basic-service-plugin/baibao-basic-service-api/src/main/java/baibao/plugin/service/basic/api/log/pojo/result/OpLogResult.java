...
public class OpLogResult implements Serializable {
     ...
     * 耗时（单位：毫秒）
     */
    @ExcelProperty("耗时（单位：毫秒）")
    private Integer timeSpent;
    /**
     * 客户端的应用的ID（标识是哪个应用）
     */
    @ExcelProperty("客户端的应用的ID（标识是哪个应用）")
    private String clientAppId;
    /**
     * 客户端的设备的ID
     */
    @ExcelProperty("客户端的设备的ID")
    private String clientDeviceId;
    /**
     * 客户端的用户代理
     */
    @ExcelProperty("客户端的用户代理")
    private String clientUserAgent;
    /**
     * 客户端的网络地址
     */
    @ExcelProperty("客户端的网络地址")
    private String clientNetAddress;
    /**
     * 客户端的地理地址
     */
    @ExcelProperty("客户端的地理地址")
    private String clientGeoAddress;
    /**
     * 客户端的地理位置（经纬度JSON）
     */
    @ExcelProperty("客户端的地理位置（经纬度JSON）")
